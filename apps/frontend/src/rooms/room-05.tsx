...
import { LEVEL_MARKS, LibraryBackdrop, ScrollMark, ShelfColumn } from './room-05-art'
 ...
 * server.
 */
export function RoomFive({ room, onAnswer, busy }: RoomProps) {
  ...
  return (
    <div className="room5-scene pointer-events-auto">
