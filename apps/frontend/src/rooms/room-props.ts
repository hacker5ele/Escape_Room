 ...
 *
 * `onResetRoom` wipes this room's own progress only (see ADR-0023) — most
 ...
 * ADR-0027) — for a room whose final stage(s) are entirely client-side, so
 ...
 * (see ADR-0026). The app does NOT advance the instant the server marks a
