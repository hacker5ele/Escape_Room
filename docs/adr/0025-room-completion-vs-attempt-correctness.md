# ADR-0025: A correct attempt and a finished room are not the same thing
...
became multi-stage (five Sphinx riddles, ADR-0022) and nobody updated `applyAttempt` to match; ADR-0024
